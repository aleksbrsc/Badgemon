#!/usr/bin/env python3
"""Convert game/assets/*.png into LVGL v9 C arrays (game/main/assets.c).

Usage:  python3 game/assets/convert_assets.py
...
def emit_c(images):
    parts = []
    parts.append('// Auto-generated by game/assets/convert_assets.py — do not edit.')
